...
import edu.eci.arsw.covid19arsw.coronaVirusStatsServices.implement.CoronaVirusStatServicesImplement;
...
public class CoronaVirusStatController {
    @Autowired
    private CoronaVirusStatServicesImplement coronaVirusStatServicesImplement;
    @RequestMapping(value="/general-stats",method = RequestMethod.GET)
    public ResponseEntity<?> getGeneralStats() {
        try{
            List<Country> countries = coronaVirusStatServicesImplement.getTopStats();
    ...
    public ResponseEntity<?> getTotalStatistics() {
            try{
                List<Country> total = coronaVirusStatServicesImplement.getTotalStatistics();
    ...
    public ResponseEntity<?> getAllStats(){
        try{
            List<Country> countries = coronaVirusStatServicesImplement.getAllGeneralStats();
    ...
    public ResponseEntity<?> getCountryStat(@PathVariable ("country") String countryName){
        try{
            List<Country> country = coronaVirusStatServicesImplement.getCountryStats(countryName);
